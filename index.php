...
<title>Hurricane 2015 Home</title>
</head>
<body>
<?php include_once("analyticstracking.php") ?>
<nav class="navbar navbar-inverse  navbar-static-top" ole="navigation" id="topnavbar">
...
<div class="alert alert-info alert-dismissible" role="alert">
  ...
  <strong>Information!</strong>...<a href="Danny.php" class="alert-link">DANNY</a> FORECAST TO STRENGTHEN OVER THE TROPICAL ATLANTIC... 
</div>
<ol class="breadcrumb">
...
<?php
$d1=strtotime("November 30");
$d2=ceil(($d1-time())/60/60/24);
//echo "There are " . $d2 ." days until the end of Hurricane Season.";
?>
...
<!--<tr><td colspan="10" align="center">Currently, there are not active storms in the Atlantic Basin</td></tr>-->
<?php
$d=strtotime("-7 days");
$from=date("Y-m-d", $d);
$to=date("Y-m-d");
$result=mysqli_query($con, "select * from Spots15 where `date` between '$from' and '$to' ORDER BY `id` DESC LIMIT 0, 60 ");	 
if(!result){
     print '<tr><td colspan=\"10\">Currently, there are not active storms in the Atlantic Basin</td></tr>';
}  
...
<div class="col-md-4">
<div id="googleMap" style="width:450px;height:380px; margin-top:10px;"></div>
</div>
</div>
</body>
</html>