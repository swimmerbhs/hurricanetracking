...
$new = array();
$result=mysqli_query($con, "select * from Spots15 where `Name` = 'Bertha' or 'Two'");
...
<title>Hurricane Tracking 2014 Bertha</title>
</head>
<body>
  ...
  <div class="container-fluid">
    ...
    <div>
      <ul class="nav navbar-nav">
        <li class="active"><a href="Bertha.php">Bertha</a></li>
...
<ol class="breadcrumb">  <li><a href="index.php">Home</a></li><li>Season 2014</li> <li class="active">Bertha</li>
</ol>
...
<?php
$result=mysqli_query($con, "select * from Spots14 where `Name` = 'Bertha' or 'Two' LIMIT 0, 50 ");	  
while($row=mysqli_fetch_array($result)){
  $id       = $row['ID'];
  $cat		= $row['CATAGORY'];
  $name		= $row['NAME']; 	
