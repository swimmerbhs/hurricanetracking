...
$new = array();
$result=mysqli_query($con, "select * from Spots15 where `Name` = 'Erika' or 'Five'");
...
<title>Hurricane 2015 Erika</title>
</head>
<body>
...
<div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="Erika.php">Erika</a></li>
         <li class="dropdown">
...
<?php
$result=mysqli_query($con, "select * from Spots15 where `Name` = 'Erika' or 'Five' LIMIT 0, 50 ");	  
while($row=mysqli_fetch_array($result)){
  $id       = $row['ID'];
  $cat		= $row['CATAGORY'];
  $name		= $row['NAME']; 	
