...
$new = array();
$result=mysqli_query($con, "select * from Spots14 where `Name` = 'Edouard' or 'Five'");
...
<title>Hurricane Tracking 2014 Edouard</title>
</head>
<body>
  ...
  <div class="container-fluid">
    ...
    <div>
      <ul class="nav navbar-nav">
        <li class="active"><a href="Edouard.php">Edouard</a></li>
...
<ol class="breadcrumb">  <li><a href="index.php">Home</a></li><li>Season 2014</li> <li class="active">Edouard</li>
</ol>
...
<?php
$result=mysqli_query($con, "select * from Spots14 where `Name` = 'Edouard' or 'Five' LIMIT 0, 50 ");	  
while($row=mysqli_fetch_array($result)){
  $id       = $row['ID'];
  $cat		= $row['CATAGORY'];
  $name		= $row['NAME']; 	
