...
$new = array();
$result=mysqli_query($con, "select * from Spots15 where `Name` = 'Claudette' or 'Three'");
...
var zero=new google.maps.LatLng(31.4, -68.1);
var one=new google.maps.LatLng(38.1, -66.9)
var two=new google.maps.LatLng(38.9, -64.9);
...
var myTrip=[zero, one, two, three, four, five, six];
...
<title>Hurricane 2015 Claudette</title>
</head>
<body>
...
<div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="Claudette.php">Claudette</a></li>
         <li class="dropdown">
...
<?php
$result=mysqli_query($con, "select * from Spots15 where `Name` = 'Claudette' or 'Three' LIMIT 0, 50 ");	  
while($row=mysqli_fetch_array($result)){
  $id       = $row['ID'];
  $cat		= $row['CATAGORY'];
  $name		= $row['NAME']; 	
