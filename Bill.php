...
var zero=new google.maps.LatLng(27.1,-94.2);
var one=new google.maps.LatLng(27.6,-95.3);
var two=new google.maps.LatLng(27.9,-95.7);
var three=new google.maps.LatLng(28.2,-96.0);
var four=new google.maps.LatLng(28.2-96.4);
var five=new google.maps.LatLng(28.2,-96.7);
var six=new google.maps.LatLng(28.4,-96.8);
var seven=new google.maps.LatLng(29.0,-96.9);
var eight=new google.maps.LatLng(29.5,-97.0);
var nine=new google.maps.LatLng(30.2,-97.0);
var ten=new google.maps.LatLng(31.0-97.1);
var eleven=new google.maps.LatLng(32.2-97.4);
function initialize()
{
var mapProp = {
  center:five,
...
var myTrip=[zero,one,two, three, four, five, six, seven, eight, nine, ten, eleven];
...
<title>Hurricane 2015 Bill</title>
</head>
<body>
...
<?php
$result=mysqli_query($con, "select * from Spots15 where `Name` = 'Bill' or 'Two' LIMIT 0, 50 ");	  
while($row=mysqli_fetch_array($result)){
  $id       = $row['ID'];
  $cat		= $row['CATAGORY'];
  $name		= $row['NAME']; 	
